...
# User model creation for sql tables
class User(db.Model):
...
class Car(db.Model):
    ...
    def __init__(self, name, description, price, mileage, dimensions, weight, 
...
class CarSchema(ma.Schema):
    class Meta:
        fields = ['id','name','description','price','mileage','dimensions',
                'weight','cost_of_production','series']
                
drone_schema = CarSchema()
drones_schema = CarSchema(many=True)